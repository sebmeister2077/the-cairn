      ...
      <CardContent className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              ...
              free-text полях. Сервис предназначен для данных карты и путевых точек, а не для общего
              обмена сообщениями.{" "}
              <strong>
                Единственное исключение — функция, специально для этого созданная — маркетплейс
                Orders
              </strong>
              , где структурированные торговые запросы и сообщения переговоров разрешены, но должны
              оставаться по теме и соответствовать разделу 6a. Оператор вправе по своему усмотрению
              изменить или удалить такое поле, отозвать ваш API key и забанить аккаунт без
              уведомления.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-foreground">
            6a. Маркетплейс сообщества (Orders)
          </h2>
          <p>
            Если маркетплейс <strong>Orders</strong> включён, вы можете размещать заявки на
            покупку/продажу и договариваться о сделках с другими пользователями. Используя его, вы
            соглашаетесь, что:
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li>
              Вы несёте единоличную ответственность за всё, что вы публикуете — детали заявки,
              произвольные заметки и сообщения переговоров — и за своё поведение с другими
              пользователями.
            </li>
            <li>
              <strong>Сделки заключаются напрямую между пользователями.</strong> Оператор{" "}
              <strong>не является стороной</strong> какой-либо сделки и не предоставляет escrow,
              обработку платежей, доставку или проверку пользователей, предметов, цен или
              внутриигровой валюты. Вы торгуете <strong>исключительно на свой страх и риск</strong>,
              и оператор не несёт ответственности за непоставку, мошенничество, споры или любые
              убытки от сделки.
            </li>
            <li>
              Вы предоставляете оператору неисключительную, всемирную, безвозмездную лицензию на
              хранение, показ и передачу созданных вами заявок и сообщений в объёме, необходимом для
              работы функции (например, публичный показ вашей открытой заявки и доставка ваших
              сообщений второму участнику).
            </li>
            <li>
              Вы не должны использовать маркетплейс для мошенничества, травли или оскорблений,
              спама, рекламы несвязанных товаров или услуг, продажи за реальные деньги или
              чего-либо, нарушающего EULA Vintage Story, незаконных товаров или услуг, выдачи себя
              за другое лицо или публикации чужих персональных данных.
            </li>
            <li>
              Оператор и администраторы могут изменять, скрывать, закрывать или{" "}
              <strong>безвозвратно удалять</strong> любую заявку, сообщение переговоров или иной
              контент маркетплейса в любой момент, с уведомлением или без. Вы можете удалить свои
              заявки в любой момент; удаление необратимо и также удаляет историю переговоров заявки.
            </li>
          </ul>
        </section>
