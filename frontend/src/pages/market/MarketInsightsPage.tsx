    ...
    const columns = useMemo<ScreenerColumn<InsightsRow>[]>(
        () => [
            ...
            },
            {
                ...
                align: "right",
                cell: (r) =>
                    r.medianPricePerUnit != null ? formatGears(r.medianPricePerUnit) : DASH,
            ...
            },
            {
                ...
                align: "right",
                cell: (r) =>
                    r.sellThrough != null ? `${(r.sellThrough * 100).toFixed(0)}%` : DASH,
            ...
            },
            {
                ...
                align: "right",
                cell: (r) =>
                    r.medianTimeToSellHours != null
                        ? formatRealTimeToSell(r.medianTimeToSellHours)
                        : DASH,
            ...
            },
            {
                ...
                align: "right",
                cell: (r) =>
                    r.deliveryPremiumPct != null ? `${r.deliveryPremiumPct > 0 ? "+" : ""}${r.deliveryPremiumPct}%` : DASH,
        ...
        <div className="space-y-5">
            <div>
                ...
                <p className="text-xs text-muted-foreground">
                    Derived indicators per item. Listing dates use the in-game calendar; time to
                    sell is real-world. Windows are real days of play (1 real day ≈ 1 in-game
                    month).
                    {summary ? (
            ...
            <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6">
                ...
                <StatCard
                    ...
                    value={
                        t.medianTimeToSellHours != null
                            ? formatRealTimeToSell(t.medianTimeToSellHours)
                            : "—"
                    }
                />
            </div>
            ...
            <div>
                <div className="mb-2 flex items-baseline justify-between">
                    ...
                    <span className="text-xs text-muted-foreground">
                        {rows.length.toLocaleString()} items · click a row for details · click a
                        header to sort
                    </span>
                </div>
                <div className="mb-3">
