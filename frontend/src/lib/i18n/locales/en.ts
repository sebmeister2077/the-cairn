export const en = {
    ...
    topsMap: {
        ...
        climateTemperatureHint:
            "Temperatures are shown at sea level. Pick a crop to highlight places where it can grow year-round (the location's coldest month stays at or above the crop's minimum, and the warmest month stays at or below the crop's maximum).",
