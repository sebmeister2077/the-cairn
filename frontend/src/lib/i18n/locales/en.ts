export const en = {
    ...
    topsMap: {
        ...
        showServerLandmarksOverlay: "Show server landmarks overlay",
        showServerLandmarks: "Server landmarks",
        showServerLandmarksSubtitle: "except Spawn",
        ...
        showTraderClaimsOverlay: "Show all trader claims overlay",
        showTraderClaims: "Show all trader claims",
        traderClaimsFound: "Trader claims:",
        showPlayerClaimsOverlay: "Show player claims overlay",
        showPlayerClaims: "Show player claims",
        playerClaimsDensityMode: "Density",
        playerClaimsSearchMode: "Search",
        playerClaimsAllMode: "All",
        playerClaimsSearchPlaceholder: "Filter by player name",
        playerClaimsMatchCount: "{count} matching claims",
        playerClaimsAllHint: "Hover a claim to see its owner",
        playerClaimsOpacity: "Opacity",
        claimMarkTitle: "Mark trader type",
        claimMarkClose: "Close",
        claimCurrentType: "Current",
        claimSignInHint: "Sign in with an account to mark trader types.",
        claimMarkError: "Could not save — please try again.",
        claimEmptyMark: "Mark as no trader (empty)",
        claimEmptyUnmark: "Clear no-trader mark",
        claimEmptyBadge: "No trader here",
        ...
        climateAltitude: "Your altitude (Y)",
        climateAltitudeReset: "Sea level",
        climateAltitudeHint:
            "Temperature & rainfall in the cursor readout are adjusted to this height. The map colors still show sea-level values.",
        climateAltitudeHintSea:
            "Set your build height to see the temperature & rainfall you'll actually get there — it changes with altitude.",
        climateAtAltitude: "At altitude",
        climateReadout: "At cursor",
        climateReadoutLoading: "Loading…",
        climateReadoutHint: "Hover the map to sample",
        climateApproxNightLow: "≈ coldest night",
        climateApproxDayHigh: "≈ hottest day",
        climateSeasonalMean: "Seasonal mean",
        ...
        markGroupingElk: {
            ...
            modeEpicenter: "Epicenter",
            epicenterHelp:
                "Pick a centre on the map; every TL endpoint inside the radius is linked to each other, regardless of how far apart they are.",
            epicenterPick: "Pick epicenter on map",
            epicenterRepick: "Re-pick epicenter",
            epicenterClear: "Clear epicenter",
            epicenterCoords: "{x}, {z}",
            epicenterNotSet: "No epicenter yet — pick one on the map to select connections.",
            pickEpicenterHint: "Click the map to place the epicenter",
            radiusLabel: "Radius",
